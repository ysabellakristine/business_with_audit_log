...
$user = "root";
$password = "";
$dbname = "toy_reseller_system_with audit";
...
try { 
    ...
    if (file_exists(__DIR__ . '/../sql/schema.sql')) {
        $schema = file_get_contents(__DIR__ . '/../sql/schema.sql');  // Reads content of the schema.sql file
